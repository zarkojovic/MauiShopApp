...
{
    /// <inheritdoc />
    public partial class AddedNewSeeders : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "#e28083", "FRT30", "Enjoy upto 30% off on all fruits", false, "Upto 30% off" },
                    ...
                    { 4, "#d0f200", "FRT25", "Enjoy 25% off on all seasonal fruits", false, "25% OFF on Seasonal Fruits" }
                });
        }
